...
class SentimentClassification:
    ...
    def plot_curves(self, train_loss, valid_loss, train_accuracy, valid_accuracy):
        ...
        plt.tight_layout()
        plt.savefig('training_validation_curves.png')  # Save the plot to a file
        plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", type=str, default=r"D:\Sentiment-Classification-with-DistilBERT-main\IMDB-Movie-Reviews-Large-Dataset-50k-master\train.xlsx", help="Path to the training data file")
